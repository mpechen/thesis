...
% END: Rust generated
  \node[text width=2cm, align=center] at (0,0.5) {System \uline{Development}};
  \node[align=center, scale=0.8] at (0, -0.1) {i};

  \node[text width=2cm, align=center]  at (0,4.5) {Theory \uline{Building}};
  \node[align=center, scale=0.8] at (0, 3.9) {Mathematical models};
  \node[align=center, scale=0.8] at (0, 3.7) {Pccf construction};
