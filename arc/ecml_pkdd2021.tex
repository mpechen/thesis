...
\begin{document}
	...
	%
	% TOMMI: Another title suggestion below
	% Does recurrency help change point detection?
	%\title{Optimality of CUSUM detector in the presence of prediction intervals}
	% \title{Does recurrency help change point detection?}
	% \title{CUSUM for recurrent changepoints detection}
...
\author{Alexandr Maslov \and Mykola Pechenizkiy \and Tommi K\"{a}rkk\"{a}inen}
%\authorrunning{Short form of author list} % if too long for running head

\institute{Alexandr Maslov
\at TU Eindhoven, Dept.\ of Mathematics and Computer Science, The Netherlands and
\at University of Jyv\"{a}skyl\"{a}, Department of Mathematical Information Technology, Finland\\
\email{maslov314@gmail.com}
\and
Mykola Pechenizkiy
\at TU Eindhoven, Dept.\ of Mathematics and Computer Science, The Netherlands\\
...
% 	%3\url{https://www.tue.nl/en/our-university/departments/mathematics-and-computer-science/}
% 	\and
% 	University of Jyv\"{a}skyl\"{a}, Department of Mathematical Information Technology, Finland\\
% 	\email{tommi.karkkainen@jyu.fi}
% }
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.9\textwidth]{img/arl.eps}
	\caption{
...
\begin{figure}[!htb]
    ...
    \includegraphics[width=0.44\textwidth, trim={1.5cm 1.0cm 0.3cm 1.0cm}]{img/proof_of_concept2.eps}
    \includegraphics[width=0.44\textwidth, trim={1.5cm 1.0cm 0.3cm 1.0cm}]{img/proof_of_concept2_fn_case.eps}
    \\
		\includestandalone[width=0.35\textwidth]{./tikz/perf_metrics_case1}
    \hspace{10mm}
		\includestandalone[width=0.35\textwidth]{./tikz/perf_metrics_case2}
		\caption{
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.90\textwidth]{img/performance_detection_sim}
...
\begin{figure}[htb!]
	\centering
	\includegraphics[width=0.4\textwidth]{./img/DHT22.png}
	\caption{
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.9\textwidth]{./img/temperature_signal}
	\caption{
...
\begin{figure}[!htb]
  ...
  \begin{tikzpicture}[scale=0.9]
		\draw(0, 0) node{\includegraphics[width=0.8\textwidth]{./img/performance_temperature_seven}};
		\draw(0, -4.8) node{\includegraphics[width=0.8\textwidth]{./img/performance_temperature}};
