...
The general requirements for the model implementation are 
\begin{itemize}
...
The model is a mapping $y=\mathcal{L}(X)$ from input variables to the target.
...
If concept drift is alarmed then model is updated using $(X_t, y_t)$.
