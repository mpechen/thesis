...
\begin{figure}[!htb]
	...
	\caption{ARIMA concept drift example}\label{fig:arima_cd_example}
\end{figure}
...
A significant decrease in the error rate of the model implies a change in the class distribution.
